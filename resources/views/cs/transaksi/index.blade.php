...
<div class="row mb-3">
    <div class="col-12">
        <ul class="nav nav-pills justify-content-center">
            <li class="nav-item">
                <a id="pillmerk" class="nav-link {{ Session::get('pengajuanall') }}" data-toggle="pill" href="#merk">Pengajuan Terverifikasi</a>
            </li>
            <li class="nav-item">
                <a id="pilltype" class="nav-link {{ Session::get('pengajuan') }}" data-toggle="pill" href="#tipe">Pengajuan Tertunda
                    ({{ count($pengajuan) }})</a>
            </li>
        </ul>
                                ...
                                @if(count($pengajuanall) > 0)
                                    @foreach($pengajuanall as $item)
                                        <tr>
                                            ...
                                            <td>
                                                <a class="btn btn-sm btn-warning" href="{{ route('csviewtransaksi', ['id'=>$item->trx_code]) }}">Lihat Detail</a>
                                            </td>
                                        </tr>
                                    @endforeach
                                @else
